  ...
  return (
    <section id="skills" className="bg-black border border-red-900 relative w-full h-screen">
      <div className="flex justify-between items-baseline px-10">
        <div className=" flex p-8 box-border  justify-between w-[50%] items-center h-10 text-2xl text-white border C my-5">
          <button className=" hover:bg-sky-700 border p-6 rounded-full">  FRONTEND </button>
